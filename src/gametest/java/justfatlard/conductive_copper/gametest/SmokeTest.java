package justfatlard.conductive_copper.gametest;
...
public final class SmokeTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		if (!FabricLoader.getInstance().isModLoaded("conductive_copper")) {
			throw new AssertionError("conductive_copper is not loaded: the test is testing nothing");
		}
